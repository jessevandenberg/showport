export const Background = () => {
  return (
    ...
    >
      {/* Edge color glows (do not obstruct content) */}
      ...
      {/* extra side glows for richer edges (kept within viewport) */}
      ...
      {/* Middle shapes (end ~90% to avoid long feel) */}
